function [A_r, A_theta, A_phi] = SH(r, theta, phi, N);
% [A_r, A_theta, A_phi] = SH(r, theta, phi, N)
%
...
[A_r, A_theta, A_phi] = SH_matlab(r, theta, phi, N);
% -----------------------------------------------------------------------

function [A_r, A_theta, A_phi] = SH_matlab(r, theta, phi, N);
